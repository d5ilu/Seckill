...
<script src="${basePath}/seckill/static/jquery-3.2.1.js"></script>
<script src="${basePath}/seckill/static/bootstrap/bootstrap.js"></script>
...
<%--开始交互逻辑--%>
<script src="${basePath}/seckill/static/seckill.js" type="text/javascript"></script>
